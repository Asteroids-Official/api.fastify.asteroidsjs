...
import { TYPE, IFastify } from '../common/types/types'
...
import { SpaceShipColorService } from './spaceship-color.service'

import { getIdFromRequest } from '../common/utils/request'
